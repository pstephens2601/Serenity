<?php
	...
	class defaults extends baseController 
	{
		...
		{
			/*---------------------------------------------------------------
				Each function created in your controller class represents
				a controller action that can be called by the Front End 
				Controller.  You should have a seperate action for each page
				on your site.
			----------------------------------------------------------------*/
		}
